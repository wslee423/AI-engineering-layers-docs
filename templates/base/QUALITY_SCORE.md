# QUALITY_SCORE.md — [프로젝트명] 품질 기준

> `core/QUALITY_SCORE_BASE.md` 내용을 인라인으로 포함.
> 프로젝트 특화 기준은 하단 "## 프로젝트 특화 기준" 섹션에 추가.

---

## 1. 사용법

이 파일은 프로젝트의 완성 기준을 단일 파일로 제공한다.
...
*(Pack 적용 시 이 섹션에 품질 기준 확장 내용 추가)*
