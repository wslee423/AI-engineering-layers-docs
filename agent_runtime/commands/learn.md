...
> `core_docs/LESSON_LIFECYCLE.md`의 5단계 승격 doctrine을 실행한다.
...
2. 전달:
   - "Mode B — /learn" 명시
   - 입력받은 문제 설명
   - `core_docs/LESSON_LIFECYCLE.md` 경로
   - 현재 프로젝트의 문서 경로:
     - `LESSONS_LEARNED.md`
     - `ANTI_PATTERNS.md`
     - `QUALITY_SCORE.md`
...
5. L4/L5인 경우 `docs/exec-plans/BACKPORT_PROPOSAL.md` 자동 생성
...
- 승인 / 수정 / 거부 응답
- L4/L5의 BACKPORT_PROPOSAL.md를 ai_engineering_docs 본체에 적용할지 별도 결정 (자동 적용되지 않음)
...
- L4/L5 변경이 ai_engineering_docs 본체에 자동 반영
  (반드시: BACKPORT_PROPOSAL.md → Owner 수동 승인 → 본체 수정 순서)
